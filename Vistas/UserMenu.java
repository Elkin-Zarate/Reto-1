...
public class UserMenu extends javax.swing.JFrame {
     ...
     */
    //crear el método que lista empleados de la base de datos
    public void listarEmpleados() {
        ...
        try {
            ...
            //ejecutamos el query que continene la variable queryConsulta
            rs = st.executeQuery(queryConsulta);
            //Creamos objeto que almacenará registros de empleados que existen en la 
            //base de datos
            Object[] empleados = new Object[5];
            contenidoTabla = (DefaultTableModel) tblEmpleados.getModel();
            //mientras el resultado del queryConsulta encuentre registros
            //en la base de datos se ingresa al while
            while (rs.next()) {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/editUser (1).png"))); // NOI18N
        jButton1.setText("Editar");

        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/showUser (1).png"))); // NOI18N
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/deleteUser (1).png"))); // NOI18N
